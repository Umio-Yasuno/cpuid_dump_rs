...
pub fn fam06h(m: u32, s: u32) -> ProcInfo {
    ...
    */
        ...
        0x8E => match s {
            ...
            0xB|
            0xC => info!("Whiskey Lake (Mobile)",   "Skylake",  "14 nm"),
            _   => info!("Kaby Lake (Mobile)",      "Skylake",  "14 nm"),
        },
        0x9E => match s {
            0xA|
            0xB|
            0xC => info!("Coffee Lake (Desktop)",   "Skylake",  "14 nm"),
        ...
        0x97 => info!("Alder Lake", "Golden Cove/Gracemont",    "10 nm eSF"),
        0x9A => match s {
            0x1 => info!("Alder Lake-M (Mobile)", "Golden Cove/Gracemont",  "10 nm eSF"),
            _   => info!("Alder Lake-P (Mobile)", "Golden Cove/Gracemont",  "10 nm eSF"),
        }
